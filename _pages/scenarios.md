...
1. Split into groups of three or four
2. Give each group a card, or let them draw one
3. Ten minutes on the questions, with someone writing down what nobody could answer
4. Share back across the room
5. Turn the gaps into actual documented procedures, which is the part everyone skips
...
The best scenarios are the ones from your own near misses. What almost went wrong. What keeps you awake. What you watched happen to somebody else's project.

If you write one, [contribute it back]({{ site.repo_resources }}/issues/new/choose) and it goes in the deck.
